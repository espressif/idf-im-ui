...
pub fn setup_environment_variables(
    ...
    let components_path = idf_path.join("components");
    env_vars.push(("IDF_COMPONENT_LOCAL_STORAGE_URL".to_string(), components_path.to_str().unwrap().to_string()));
