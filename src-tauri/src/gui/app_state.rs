...
pub struct AppState {
    ...
    idf_mirror_latency_entries: Mutex<Option<Vec<MirrorEntry>>>,
    tools_mirror_latency_entries: Mutex<Option<Vec<MirrorEntry>>>,
    pypi_mirror_latency_entries: Mutex<Option<Vec<MirrorEntry>>>,
}
