      ...
      <div class="ready-status">
        ...
        <div class="installation-summary">
          <div class="summary-item">
            <span class="summary-label">{{ $t('simpleSetup.ready.version') }}:</span>
            <span class="summary-value">{{ selectedVersion }}</span>
          </div>
          <div class="summary-item">
            <span class="summary-label">{{ $t('simpleSetup.ready.path') }}:</span>
            <span class="summary-value">{{ installPath }}</span>
          </div>
          <div class="summary-item">
            <span class="summary-label">{{ $t('simpleSetup.ready.size') }}:</span>
            <span class="summary-value">~3.5 GB</span>
          </div>
          <div class="summary-item">
            <span class="summary-label">{{ $t('simpleSetup.ready.time') }}:</span>
    ...
    <n-card v-else-if="currentState === 'complete'" class="status-card">
      <div class="complete-status">
        ...
        <div class="post-install-info">
          <h3>{{ $t('simpleSetup.complete.nextSteps') }}</h3>
          <ol>
